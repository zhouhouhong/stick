...
function(t, e, n) {
    ...
    function r() {
        if ("over" != y && "pass" != y) {
            ...
            if ("shooting" == y) {
                ...
                T ? (e = w * D(T.a), 
				e = w * A(T.a) + n.sqrt(4 * p * p - e * e), 
				a(t, e), 
				y = "over", 
				c.save().font("bold 18px sans-serif").textAlign("right").fillStyle("#f00").fillText("失败了！", h - 10, g - 45).fillText("1秒后重新开始", h - 10, g - 20).restore(), 
				stop(), 
				setTimeout(l, 1e3)) : 1 > e ? a(t, u) : (q.push(i(t - z)), 
				o(t), 
				y = "idle", 
				j || (y = "pass", ("jfcz-data", '{"aa":' + (F + 1) + "}"), 
				c.save().font("bold 18px sans-serif").textAlign("right").fillStyle("#060").fillText("完美过关！", h - 10, g - 45).fillText("1秒后下一关", h - 10, g - 20).restore(), 
				setTimeout(l, 1e3)))
            }
    ...
    v = 50, p = 10, w = 140, b = 5e3, x = 200, S = 100, y = "", M = 2 * n.PI, C = n.PI / 2, A = n.cos, D = n.sin, c = MC("#stage"), 
	u = c.ctx, h = u.canvas.width, g = u.canvas.height, m = h / 2, d = .4 * g, c.fillStyle("#000").strokeStyle("#000"), 
	c.font("12px sans-serif").textAlign("center").textBaseline("middle"), L = [0, C], q = L.concat(), E = 4 * n.asin(p / 2 / w), 
	["touchstart", "MSPointerDown", "pointerdown"].forEach(function(t) {
        //console.log(e)
